...
park, late sun). When `H3-SHOWCASE-BMX-8s-720p.mp4` is present, the image
links to the clip (github.com blob viewer plays it). Until then the 720p
href 404s — use the PNG itself.
...
| [`H3-SHOWCASE-BMX-8s-720p.mp4`](H3-SHOWCASE-BMX-8s-720p.mp4) | Preferred in-repo playback (~4.1 MB, 8.0 s, must have `moov`). **Not committed until a complete file passes that gate.** |
